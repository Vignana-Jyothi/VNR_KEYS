      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-xl md:text-3xl font-bold text-white mb-1 md:mb-2 flex items-center gap-2 md:gap-3">
            <Key className="w-6 h-6 md:w-8 md:h-8 text-blue-400 flex-shrink-0" />
            Manage Keys
          </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 flex-1">
              ...
              <div className="flex gap-3 flex-wrap">
                <select
                  ...
                  className="flex-1 sm:flex-none px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm min-w-[120px]"
                >
