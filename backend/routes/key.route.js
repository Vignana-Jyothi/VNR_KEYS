...
// Bulk operations — security scans QR on faculty's behalf, or faculty/admin calls directly
// take-bulk: security scans the QR generated by faculty → keys assigned to faculty (requestedByUserId)
// return-bulk: same pattern for returns
router.post("/take-bulk", rolePermissions.adminOrSecurityOrFaculty, takeBulk);
router.post("/return-bulk", rolePermissions.adminOrSecurityOrFaculty, returnBulk);
